...
class WindowMSA(BaseModule):
    ...
    def __init__(self,
        ...
        self.qkv = lora.Linear(embed_dims, embed_dims * 3, r=lora_r, lora_alpha=lora_alpha, merge_weights=False)
        self.proj = lora.Linear(embed_dims, embed_dims, r=lora_r, lora_alpha=lora_alpha, merge_weights=False)
