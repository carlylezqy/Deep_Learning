...
class UNet(LightningModule):
    def __init__(self, data_dir, model_name, BATCH_SIZE, in_channels=3, n_classes=1, checkpoint=None):
        ...
        self.transform = A.Compose([
            ...
            #A.ShiftScaleRotate(shift_limit=0, rotate_limit=0, scale_limit=(0, 1), p=1),
        ...
        self.model = smp.Unet(
            encoder_name=self.model_name,        # choose encoder, e.g. mobilenet_v2 or efficientnet-b7 resnet34
            encoder_depth=5,
            encoder_weights="xception",     # use `imagenet` pre-trained weights for encoder initialization
    ...
    def shared_step(self, batch, stage):
        ...
        #self.log(f"{stage}/", y_hat, logger=False, on_step=False, on_epoch=False)
