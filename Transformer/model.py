...
class ViT(nn.Module):
    def __init__(self, in_channels=1, num_encoders=5, len_embedding=128, num_heads=8, patch_size=4, input_res=28, num_classes=10, device="cpu"):
...
if __name__ == "__main__":
    model = ViT(in_channels=3, num_classes=10)
